...
When `q = 3`, `gcd(q, |Aut(C_2 × C_2)|) = gcd(3, 6) = 3`, so the action of the
Sylow `q`-subgroup on a `C_2 × C_2` Sylow `2`-subgroup can be non-trivial.
This yields an additional isomorphism class: `(C_2 × C_2) ⋊ C_3 ≃ A_4`. -/
