...
`n₃ = 4`. The four Sylow 3-subgroups contribute 8 elements of order 3, whose
`z`-translates are 8 elements of order 6, so the 8 remaining elements of 2-power order
form a single Sylow 2-subgroup. -/
